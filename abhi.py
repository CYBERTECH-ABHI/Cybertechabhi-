...
╔══────────────────────────────────╗
║OWNER 💓💓💓 CYBERTECH-ABHI (CTA)       ║
║  GITHUB 💝💝💝 CYBERTECH-ABHI          ║
║ FACEBOOK 💝💝💝CT-ABHI                 ║
║  ENJOY 💝💝💝Pak Cloning               ║
...
""")
CorrectUsername = "CYBERTECH-ABHI"
CorrectPassword = "CTABHI"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-https://wa.me/+923429837570')
    else:
...
def Zeek():
    ...
    print '\x1b[1;96m ════(CTA)'
    time.sleep(0.10)
    print '\x1b[1;97m════CYBERTECH-ABHI'
    time.sleep(0.10)
...
\033[1;95mFb\033[1;97mCYBERTECH-ABHI"""
